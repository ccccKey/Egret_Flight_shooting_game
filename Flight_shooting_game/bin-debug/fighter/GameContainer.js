...
(function (fighter) {
    ...
    var GameContainer = (function (_super) {
        ...
        GameContainer.prototype.createGameScene = function () {
            ...
            this.myFighter.y = this.stageWidth - this.myFighter.height - 50;
        ...
        GameContainer.prototype.createEnemyFighter = function (evt) {
            ...
            enemyFighter.x = Math.random() * (this.stageWidth - enemyFighter.width); //随机坐标
        ...
        GameContainer.prototype.touchHandler = function (evt) {
            if (evt.type == egret.TouchEvent.TOUCH_MOVE) {
                var tx = evt.localX;
                tx = Math.max(0, tx);
                tx = Math.min(this.stageWidth - this.myFighter.width, tx);
                this.myFighter.x = tx;
            }
        };
        /**游戏碰撞检测*/
        ...
        GameContainer.prototype.gameStop = function () {
            ...
            this.scorePanel.x = (this.stageWidth - this.scorePanel.width) / 2;
